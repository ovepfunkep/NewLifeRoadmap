  ...
  return (
    <div>
      ...
      >
        ...
        <span className="flex-1 text-sm text-gray-900 dark:text-gray-100 truncate group-hover:text-accent transition-colors">
          {node.title}
        </span>
        {badge}
    ...
    >
      ...
      >
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-accent/5">
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2" style={{ color: 'var(--accent)' }}>
