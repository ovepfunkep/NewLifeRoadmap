...
export const i18n: Record<Language, Record<string, any>> = {
  en: {
    ...
    editor: {
      ...
      recurrenceTimePairRequired: 'Set both start and end time, or leave both empty',
  ...
  ru: {
    ...
    editor: {
      ...
      recurrenceTimePairRequired: 'Укажите обе границы времени или оставьте обе пустыми',
